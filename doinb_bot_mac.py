...
class Overlay(QWidget):
	...
	def typeTimers(self):
		#Using pynput keyboard beacuse it is faster, which I have found to be a noticeable in-game influence
		keyboardP = Controller()
		response = requests.get("https://127.0.0.1:2999/liveclientdata/gamestats", verify = False)
		gameStats = response.json()
		gameTime = gameStats['gameTime']
